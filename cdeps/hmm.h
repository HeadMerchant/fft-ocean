...
// COVERAGE(HMM_EqV2, 1)
// bool HMM_EqV2(HMM_Vec2 Left, HMM_Vec2 Right) {
//   ASSERT_COVERED(HMM_EqV2);
//   return Left.X == Right.X && Left.Y == Right.Y;
// }

// COVERAGE(HMM_EqV3, 1)
// bool HMM_EqV3(HMM_Vec3 Left, HMM_Vec3 Right) {
//   ASSERT_COVERED(HMM_EqV3);
//   return Left.X == Right.X && Left.Y == Right.Y && Left.Z == Right.Z;
// }

// COVERAGE(HMM_EqV4, 1)
// bool HMM_EqV4(HMM_Vec4 Left, HMM_Vec4 Right) {
...
HMM_Mat4 HMM_Orthographic_RH(float Left, float Right, float Bottom, float Top,
...
HMM_Mat4 HMM_InvPerspective(HMM_Mat4 PerspectiveMatrix) {
...
HMM_Quat _HMM_MixQ(HMM_Quat Left, float MixLeft, HMM_Quat Right,
                   float MixRight) {
  HMM_Quat Result;
...
HMM_Quat HMM_QFromAxisAngle(HMM_Vec3 Axis, float Angle) {
...
HMM_Vec3 HMM_RotateV3AxisAngle(HMM_Vec3 V, HMM_Vec3 Axis, float Angle) {
  ASSERT_COVERED(HMM_RotateV3AxisAngle_RH);

  return HMM_RotateV3Q(V, HMM_QFromAxisAngle(Axis, Angle));
}
